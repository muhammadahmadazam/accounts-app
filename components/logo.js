...
const LogoComponent = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white pb-24 ">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Explore our extensive range of services offered across various
            cities in the UK. We provide top-notch solutions tailored to your
            needs, wherever you are.
          </p>
          <button
            className="bg-[#3b445f] text-white py-2 px-6 rounded-lg hover:bg-blue-600 transition duration-300"
            onClick={handleClick}
          >
            Our Services
          </button>
      ...
      <div className="bg-white relative w-full md:w-1/2 h-96 md:h-auto mt-16 pr-4">
        {' '}
